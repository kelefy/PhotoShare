...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _iconView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, W, W)];
        _iconView.clipsToBounds = YES;
        _iconView.layer.cornerRadius = W/2;
        _iconView.contentMode = UIViewContentModeScaleAspectFill;
        [self addSubview:_iconView];
        
        _titleLabel = nil;//[[UILabel alloc] initWithFrame:CGRectMake(0, _iconView.bottom + 5, W, 15)];
